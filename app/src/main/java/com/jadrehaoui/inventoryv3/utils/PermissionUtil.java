...
import com.jadrehaoui.inventoryv3.R;

public class PermissionUtil {
    public static boolean hasPermission(final Activity activity, final String permission, int rationaleMessageId, final int requestCode) {
